...
image yukari_f angry = Transform("yukari angry",xzoom=-1.0)
image yukari_f angry_mouth_closed = Transform("yukari angry_mouth_closed",xzoom=-1.0)
image yukari_f laugh_eyes_closed = Transform("yukari laugh_eyes_closed",xzoom=-1.0)
image yukari_f sad_angry = Transform("yukari sad_angry",xzoom=-1.0)
image yukari_f sad = Transform("yukari sad",xzoom=-1.0)
...
image sumiko_f angry = Transform("sumiko angry",xzoom=-1.0)
image sumiko_f angry_mouth_closed = Transform("sumiko angry_mouth_closed",xzoom=-1.0)
image sumiko_f laugh_eyes_closed = Transform("sumiko laugh_eyes_closed",xzoom=-1.0)
image sumiko_f sad_angry = Transform("sumiko sad_angry",xzoom=-1.0)
image sumiko_f sad = Transform("sumiko sad",xzoom=-1.0)
...
image shunsuke_f angry = Transform("shunsuke angry",xzoom=-1.0)
image shunsuke_f angry_mouth_closed = Transform("shunsuke angry_mouth_closed",xzoom=-1.0)
image shunsuke_f laugh_eyes_closed = Transform("shunsuke laugh_eyes_closed",xzoom=-1.0)
image shunsuke_f sad_angry = Transform("shunsuke sad_angry",xzoom=-1.0)
image shunsuke_f sad = Transform("shunsuke sad",xzoom=-1.0)
...
image mayumi_f angry = Transform("mayumi angry",xzoom=-1.0)
image mayumi_f angry_mouth_closed = Transform("mayumi angry_mouth_closed",xzoom=-1.0)
image mayumi_f laugh_eyes_closed = Transform("mayumi laugh_eyes_closed",xzoom=-1.0)
image mayumi_f sad_angry = Transform("mayumi sad_angry",xzoom=-1.0)
image mayumi_f sad = Transform("mayumi sad",xzoom=-1.0)
...
image yuuko_f angry = Transform("yuuko angry",xzoom=-1.0)
image yuuko_f angry_mouth_closed = Transform("yuuko angry_mouth_closed",xzoom=-1.0)
image yuuko_f laugh_eyes_closed = Transform("yuuko laugh_eyes_closed",xzoom=-1.0)
image yuuko_f sad_angry = Transform("yuuko sad_angry",xzoom=-1.0)
image yuuko_f sad = Transform("yuuko sad",xzoom=-1.0)
