...
label week_1_2:
    ...
    menu:
        "Read books about management":
            ...
            "She spends the day reading about team management and leadership techniques."
        "Network with people":
            $choice_1_2_2()
    ...
    call expression random_game_event from _call_expression_8
...
label week_2_1:
    ...
    $random_game_event = rd_e_holder.singleRandom(rd_e_holder.all)
    call expression random_game_event from _call_expression_9
label week_2_3:
    $fastForwardDays(2)
    scene studio_main with fade
    show yukari at pos_left
...
label week_3_2:
    ...
    $random_game_event = rd_e_holder.singleRandom(rd_e_holder.all)
    call expression random_game_event from _call_expression_10
label week_3_3:
    $nextDay()
    scene studio_main with fade
    ...
    $random_game_event = rd_e_holder.singleRandom(rd_e_holder.all)
    call expression random_game_event from _call_expression_11
...
label week_3_4:
    ...
    menu:
        ...
        "I'll overcome this with my own willpower":
            $choice_3_3_2()
...
label week_4_1:
    ...
    call expression random_game_event from _call_expression_12
...
label week_4_3:
    ...
    $random_game_event = rd_e_holder.random([rd_e_holder.all,rd_e_holder.wk_4,rd_e_holder.wk_4_to_12])
    call expression random_game_event from _call_expression_13
