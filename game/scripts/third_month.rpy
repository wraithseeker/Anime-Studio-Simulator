...
label epilogue:
    ...
    # if anime_score <= ANIME_MIN_FLOP_VALUE:
    #     m "Well?" 
    ...
    #     y "…Oh." 
    #     ss "What's wrong?" 
    #     "She takes a deep breath and relays the news to the team as gently as she can. Hardly anyone watched [anime.name], and those few who did were unimpressed. Reading the harsh words from viewers hurts, but not as much as seeing how many people didn't bother to watch at all." 
    ...
    #     "She breaks the news to her grandmother the next day. Although her grandmother shares her disappointment, she reminds her that at least she learned many valuable lessons about how to manage a team and produce an anime. In the end, she encourages Yukari to learn from her mistakes and try again when she's more prepared." 
    ...
    #     "Unfortunately, the reactions are pretty negative. Some viewers already knew about [anime.name] because of its marketing, while others just tuned in to see what it was, but almost none of them enjoyed it. Only a handful of people seem interested in watching Episode Two when it airs." 
    ...
    #     y "Really?" 
    #     ss "Yes. Not many, but here's one who says… 'It's a shame [anime.name] turned out the way it did, because you can tell the team loved making it. Even if the second episode doesn't fix the first episode's flaws, at least we have a promising studio to keep an eye on.'" 
    ...
    #     "The next time she talks to her grandmother, she's calm enough to tell her the unfortunate news without breaking down. Although both of them are disappointed, they know this isn't the end. It will be difficult for Yukari to try again after this. She won't be able to do it right away." 
    ...
    #     "People's reactions are pretty mixed. Some enjoyed the episode, but many people point out flaws in it. There are even a couple debates about whether certain aspects of [anime.name] are justified or not. More than one person points out that it was made by a tiny new studio, and Yukari isn't sure if that should make her feel better or worse." 
    #     m "Well?" 
    #     y "Just a minute." 
    ...
    #     "In her heart, Yukari knows how unlikely it is that a group of fans making their first anime over the span of three months would create the latest hit, but it's still a little irritating to hear these frequent comments on how this lukewarm reception was to be expected." 
    ...
    #     y "Th-thank you…" 
    #     "Next project? He's as bad as Shunsuke. She finishes the conversation in a daze. Do they really think it will be that easy to pick up and try again? Even if they do, it could be more difficult to get attention, since dissatisfied viewers will be wary of their studio." 
    ...
    #     "Partway into their celebration, a knock at the door heralds the arrival of Sumiko's friends. Yukari almost forgot she invited them after they completed their work on the animation, but now she's delighted to see them—especially since they seem thrilled at how [anime.name] turned out." 
    ...
    #     y "People… liked it!" 
    #     "[anime.name] isn't getting as much attention as the big names, of course, but quite a few people are talking about Episode One and their hopes for Episode Two." 
    ...
    #     "Sumiko's friends arrive after a short while, all bubbling with excitement over [anime.name]. Part of it is due to their own work on the project, but a lot is because they just enjoyed watching it. It's a lively party, and Yukari is a little disappointed when it ends." 
    ...
    #     s "Yes!" 
    #     yuu "Oh, I'm glad!" 
    #     "She continues to read through comments, growing more excited by the minute. It feels like a dream, but she knows she's awake. She'd hoped [anime.name] would see a decent reception… but this is better than she ever expected!" 
    ...
    #     y "Hello?" 
    #     va_director "Hello, Yukari. Have you seen what people are saying about [anime.name]?" 
    #     y "Yes! I can hardly believe it!" 
    #     va_director "I watched the episode too, and the praise is well-deserved. Good job, Yukari. Congratulations!" 
    #     y "Thank you!" 
    #     va_director "Please extend my congratulations to the rest of your team, as well. Oh, and when you're ready to record audio for your next project, please keep us in mind." 
    ...
    #     y "Thank you!" 
    #     "Sumiko's friends arrive a moment later and nearly trip over the investor trying to get into the studio. They're all talking at once, too excited over [anime.name] to wait. Yukari can understand their excitement. Not only did they get to watch something they contributed to on TV, but it's actually a success." 
    #     "Everyone is in high spirits. Yukari sets out food, and everyone spends the next hour celebrating the success of [anime.name] and their work together. The bright atmosphere is punctuated by Shunsuke reading praise from reviews at regular intervals." 
    ...
    #     "Wordlessly, Yukari waves her hand at the computer. Everyone online is talking about [anime.name]. Lots of people tuned in to check out the first episode, and almost all of them loved it. Fans are abuzz with speculation on where the story will go in the second episode and whether or not more will follow if [anime.name] does well." 
    #     s "Whoa! We're famous!" 
    ...
    #     y "Hello?" 
    #     va_director "Congratulations! [anime.name] is a hit!" 
    #     y "Thank you! I can hardly believe people love it so much." 
    #     va_director "I watched the episode, and I'm not surprised at all. It turned out fantastic. Good work." 
    #     y "Thanks." 
    #     va_director "Have you considered continuing the story with a sequel? We should be able to get the voice actors back together." 
    #     y "We don't have any immediate plans, but I'll keep that in mind." 
    #     va_director "Great! Congratulations again, and please extend my congratulations to the rest of your studio." 
    #     y "I will. Thank you!" 
    ...
    #     ss "Yes, many sites have already covered it. Here's another: 'A new anime from an untried studio started by teenagers sounds like the recipe for disappointment. However, the first episode of [anime.name] was a joy from start to finish. The only thing disappointing is that only one other episode is slated to air.'" 
    ...
    #     "The studio door opens again and Sumiko's friends arrive. They barely glance at the investor in their excitement to discuss [anime.name]. Some of them already received calls from former classmates and other acquaintances who saw their names in the credits. They also watched the episode themselves and love how it turned out." 
    ...
    #     "After that, their celebration begins in earnest with food, soda, and a selection of bad movies Sumiko puts on despite fervent protests. Once the party gets going, Yukari slips out to make a phone call. After all, there's one more person who made [anime.name] possible." 
    #     play sound "music/sfx/phone_ringing.ogg"  
    #     grandma "Hello?" 
    #     y "Hi, Grandma. It's me, Yukari." 
    #     grandma "Yukari! I just watched the first episode of [anime.name]. That was wonderful! I'm so proud of how far you've come. What happened to that little girl who used to share her secrets with me? How did that little girl create something so impressive?" 
    ...
    #     "They begin discussing the details of their next project sooner than Yukari expected. Shunsuke has more story ideas than he knows what to do with. Yuuko starts sketching potential character designs in her spare time. Sumiko presents Yukari with a new background, 'just in case' they need one soon. Mayumi cuts straight to the chase and asks when they can begin work." 
